...
class Main():
    BasicInformation = {"Config File": os.path.join(os.path.dirname(__file__), "./HeaderConfig.json"), "Target":str(args.t), "OutputFile": os.path.join(os.path.dirname(__file__), "{}Output.csv".format(str(args.t).replace("/","")))}
